...
const androidResDir = path.join(__dirname, '../../frontend/android/app/src/main/res');
const iosAppIconDir = path.join(__dirname, '../../frontend/ios/Runner/Assets.xcassets/AppIcon.appiconset');
