...
class VianTheme {
  ...
  static const Color primaryGoldLight = Color(
    0xFFC6A15B,
  ); // Stitch Primary Container Gold
  static const Color champagneGold = Color(0xFFF8EBE6); // Warm Sand Highlights
  static const Color darkBackground = Color(
    0xFF14141A,
  ); // Stitch Dark Background
  static const Color headerBlack = Color(
    0xFFE9E1D9,
  ); // On Background (Near-white)
