                ...
                children: [
                  ...
                  AnimatedBuilder(
                    ...
                    builder: (context, child) {
                      ...
                      final angle =
                          (1.0 - _logoController.value) * math.pi * 0.25;
                        ...
                        child: Transform.rotate(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: VianTheme.primaryGold.withOpacity(
                                    0.08 * _logoController.value,
                                  ),
                                  blurRadius: 30,
                                  spreadRadius: 5,
                                ),
  ...
  void paint(Canvas canvas, Size size) {
    final paintGrid = Paint()
      ..color = const Color(0xFF0F1B29)
          .withOpacity(0.18) // Steel blue drafting grid
      ..strokeWidth = 1.0;
    ...
    if (animationValue > 0.4) {
      ...
      if (progress > 0.5) {
        ...
        canvas.drawLine(
          ...
          Offset(midX, rect.top + (rect.height * (progress - 0.5) * 2)),
          paintBlueprint,
        );
        canvas.drawLine(
          Offset(rect.left, midY),
          Offset(rect.left + (rect.width * (progress - 0.5) * 2), midY),
          paintBlueprint,
        );
      }
    }
    ...
    if (animationValue > 0.8) {
      final textPainter = TextPainter(
        text: TextSpan(
          text:
              "SCALE: 1:50  |  DRAFT AREA: ${size.width.toInt()}x${size.height.toInt()}",
